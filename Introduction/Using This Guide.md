# Official Material
Consider *[[Items/Curse of Strahd- Reloaded|Curse of Strahd: Reloaded]]* your all-in-one guide to running this campaign. You'll only need to reference the original *[[Items/Curse of Strahd|Curse of Strahd]]* module when this guide tells you to do so, though you should feel free to read the original module to familiarize yourself with the bones of the campaign first.

> [!warning]+ **A Brand-New [[Places/Barovia|Barovia]]**
> *Curse of [[NPCs/Strahd von Zarovich|Strahd]]: Reloaded* is meant to be a complete substitute to the original *[[Items/Curse of Strahd|Curse of Strahd]]*, incorporating the original material only by reference. 
> 
...
> [!warning]+ **2014 Rules**
> 
> This guide has not been updated for the [[Places/Dungeons|Dungeons]] & Dragons 2024 rules update. Readers are advised to use the 2024 rules, including the revised [[Items/Player's Handbook|Player's Handbook]], [[Items/Monster Manual|Monster Manual]], and [[Items/Dungeon Master's Guide|Dungeon Master's Guide]], at their own risk.
...
* the *[[Items/Player's Handbook|Player's Handbook]]*,
* the *[[Items/Dungeon Master's Guide|Dungeon Master's Guide]]*
* the *[[Items/Monster Manual|Monster Manual]]*,
* *[[Items/Xanathar's Guide to Everything|Xanathar's Guide to Everything]]*, and
* *[[Items/Van Richten's Guide to Ravenloft|Van Richten's Guide to Ravenloft]]*.

When we reference one of these sourcebooks, you'll find the necessary citation in parentheses, formatted like this: <span class="citation"><em>[[Items/Van Richten's Guide to Ravenloft|Van Richten's Guide to Ravenloft]]</em>, p. 66</span>. If you lack the required sourcebook, you can make a homebrewed statblock or find a suitable replacement.

> [!warning] **Brewer Beware**
> The original *[[Items/Curse of Strahd- Reloaded|Curse of Strahd: Reloaded]]* was a highly modular guide, containing a number of distinct ideas, concepts, and challenges that could easily be extracted, applied, and recombined alongside a number of additional reworks or homebrew elements. However, this revision aims to take a more cohesive path, weaving together characters, narratives, and themes to forge a more evocative, dramatic, and memorable adventure.
> 
...
> 
> This danger is especially present when combining *Reloaded* with additional third-party *Curse of [[NPCs/Strahd von Zarovich|Strahd]]* guides or supplements, many of which have been designed for campaigns with different tones, narratives, or themes. Remember that each comprehensive guide to *Curse of Strahd*—including this one—has been written as a complete, integrated experience, and that weaving different threads together may instead cause the entire tapestry to fall apart.
# Sidebars
